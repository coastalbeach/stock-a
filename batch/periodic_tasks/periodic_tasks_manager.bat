REM filepath: c:\Users\coast\Desktop\stock-a\batch\periodic_tasks\periodic_tasks_manager.bat
@echo off
setlocal enabledelayedexpansion

:: 综合任务管理批处理程序
:: 提供菜单界面，可以执行日度、周度、月度、季度数据处理任务，或者执行所有数据处理任务，以及设置自动执行计划
...
echo ================================================
echo.
echo 正在启动周度数据获取批处理程序...
echo.
start "周度数据获取" /wait "%DATA_FETCHER_DIR%\weekly_data_fetcher.bat"
echo.
echo 周度数据处理任务已完成。
echo.
pause
